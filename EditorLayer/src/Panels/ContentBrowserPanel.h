...
namespace VulkanCore {
	...
	private:
		...
		std::shared_ptr<Texture2D> m_DirectoryIcon, m_FileIcon, m_BackIcon, m_RefreshIcon;
		VkDescriptorSet m_DirectoryIconID, m_FileIconID, m_BackIconID, m_RefreshIconID;
