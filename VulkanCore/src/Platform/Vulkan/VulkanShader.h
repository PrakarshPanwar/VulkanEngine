...
namespace VulkanCore {
	...
	public:
		...
		VulkanShader(const std::string& vertPath, const std::string& fragPath, const std::string& geomPath = "");
		VulkanShader(const std::string& compPath);
		~VulkanShader();
	...
	private:
		std::tuple<std::string, std::string> ParseShader(const std::string& vertPath, const std::string& fragPath);
		std::tuple<std::string, std::string, std::string> ParseShader(const std::string& vertPath, const std::string& fragPath, const std::string& geomPath);
		std::string ParseShader(const std::string& compPath);
		void ParseShader();
