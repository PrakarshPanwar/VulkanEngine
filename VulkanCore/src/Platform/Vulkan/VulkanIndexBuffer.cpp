...
namespace VulkanCore {
		...
		: m_Size(size)
	{
		...
		VkBufferUsageFlags usage = VK_BUFFER_USAGE_TRANSFER_DST_BIT | VK_BUFFER_USAGE_INDEX_BUFFER_BIT | VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT |
	...
	uint64_t VulkanIndexBuffer::GetVulkanBufferDeviceAddress(uint64_t offset) const
	{
