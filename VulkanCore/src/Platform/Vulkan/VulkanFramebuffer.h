...
namespace VulkanCore {
	...
	public:
		...
		const std::vector<std::shared_ptr<Image2D>>& GetDepthAttachment(bool resolve = false) const;
	...
	private:
		...
		std::vector<std::shared_ptr<Image2D>> m_DepthAttachment;
		std::vector<std::shared_ptr<Image2D>> m_DepthAttachmentResolve;
