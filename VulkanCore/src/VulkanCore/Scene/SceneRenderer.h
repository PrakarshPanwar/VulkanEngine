...
namespace VulkanCore {
	...
	private:
		...
		std::shared_ptr<Pipeline> m_ExternalCompositePipeline; // To handle Bloom
		std::shared_ptr<Pipeline> m_CompositePipeline; // Final Compositing(along with Depth of Field)
		std::shared_ptr<Pipeline> m_SkyboxPipeline;
		std::shared_ptr<ComputePipeline> m_BloomPipeline;
		std::shared_ptr<ComputePipeline> m_DOFPipeline;
		...
		std::shared_ptr<Material> m_ExternalCompositeShaderMaterial;
		std::shared_ptr<Material> m_CompositeShaderMaterial;
		std::shared_ptr<Material> m_DOFMaterial;
		...
		std::vector<std::shared_ptr<UniformBuffer>> m_UBDOFData;
