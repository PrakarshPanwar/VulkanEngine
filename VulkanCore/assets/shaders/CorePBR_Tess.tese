...
#define TESSELLATION_STRENGTH 0.1
...
void main()
{
	...
	Output.WorldNormals[1] = normalize(MixTess(Input[0].WorldNormals[1], Input[1].WorldNormals[1], Input[2].WorldNormals[1])); // Bitangent
	Output.WorldNormals[2] = normalize(MixTess(Input[0].WorldNormals[2], Input[1].WorldNormals[2], Input[2].WorldNormals[2])); // Normal
